/*  doBit_112            doBits Labs - Humdan Bakhshi
    version 1.1.2        12/22/2016
    Description:

//History___
v112: reset button removed AP password added to: domoregooder
...
void setup() {
  ...
  if (!wifiManager.autoConnect("doBits_0","domoregooder")) {
